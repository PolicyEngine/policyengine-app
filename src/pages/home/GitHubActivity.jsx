  ...
  >
    ...
    <Content style={{
      ...
      <RepoName>
        ...
        {pr.head.repo.full_name}</RepoName>
      <PRTitle>{pr.title}</PRTitle>
      <PRInfo>#{pr.number} opened by {pr.user.login} {moment(pr.created_at).fromNow()}</PRInfo>
    </Content>
  </Card></motion.div>
);
