...
/**
 * Shared AI page content used by both US and UK versions
 * @param {Object} props
 * @param {string} props.countryId - The country ID (us or uk)
 * @param {boolean} props.isUK - Whether this is the UK version (for spelling differences)
 */
const AIContent = ({ countryId, isUK = false }) => {
