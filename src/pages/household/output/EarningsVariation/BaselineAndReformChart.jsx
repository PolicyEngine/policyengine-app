...
import { getPlotlyAxisFormat, getValueFromHousehold } from "../../../../api/variables";
...
export default function BaselineAndReformChart(props) {
    ...
    const toggle = <div style={{ display: "flex", justifyContent: "center" }}>
...
function BaselineAndReformTogetherChart(props) {
    ...
    let data = [
        ...(variable === "household_net_income" ? getCliffs(baselineArray, earningsArray) : []),
        ...(variable === "household_net_income" ? getCliffs(reformArray, earningsArray, true) : []),
        {
          x: earningsArray,
          y: baselineArray,
          type: "line",
