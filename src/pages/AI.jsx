...
const AIPage = () => {
  ...
  // Return UK version if country is UK
  if (countryId === "uk") {
    return <UKAIPage />;
  }
      ...
      <Section style={{ marginTop: 0, paddingTop: "1rem" }}>
        <div className="hero-section">
          ...
          <div className="hero-image">
            <img 
              src={require("../images/posts/us-household-ai.png")} 
      ...
      <Section title="Our AI Journey">
        <div className="journey-container">
          <div className="journey-text">
            ...
            <p>
              PolicyEngine has leveraged artificial intelligence since our inception. In 2021, we pioneered the use of machine learning to enhance our microsimulation models, applying gradient descent to optimize survey weights and match administrative totals with unprecedented accuracy.
            </p>
            <p>
      ...
      <Section title="Features">
        <div className="features-container">
          ...
          <div className="feature">
            ...
            <ul>
              <li><strong>LLM Tax Behavior Analysis:</strong> Exploring how large language models perceive behavioral responses to tax policy changes</li>
      ...
      <Section title="Our Vision">
        <div className="vision-container">
          ...
          <div className="vision-image">
            <img 
              src={require("../images/posts/enhanced-cps-beta.png")} 
