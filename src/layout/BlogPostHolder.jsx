...
function BlogPostPreviewRegular(props) {
    ...
    >
        <img src={imageSrc} style={{width: 300, height: 200, objectFit: "cover", borderTopLeftRadius: 20, borderTopRightRadius: 20}} alt="Preview" />
...
export default function BlogPostHolder(props) {
    ...
    for (let i = 0; i < postJson.length; i++) {
        posts.push(<BlogPostPreviewRegular {...postJson[i]} countryId={countryId} />);
    }
    ...
    return <div style={{
        ...
        <div style={{minWidth: 300, display: "flex", justifyContent: "center", alignItems: "center"}}>
            <div>
            <h3>Blog</h3>
            </div>
        </div>
