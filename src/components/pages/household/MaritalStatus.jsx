...
export default function MaritalStatus(props) {
  ...
  const getMaritalStatus =
    PolicyEngine.country == "uk" ? getUKMaritalStatus : getUSMaritalStatus;
  const setMaritalStatusInHousehold =
    PolicyEngine.country == "uk" ? setUKMaritalStatus : setUSMaritalStatus;
  ...
  const radioButtonComponent = (
    <RadioButton
      ...
      value={
        PolicyEngine.simulatedHousehold &&
        getMaritalStatus(PolicyEngine.household)
      }
    ...
    <>
      ...
      >
        ...
        <h4
          ...
          onClick={() =>
            PolicyEngine.setState({ householdPage: "structure.children" })
          }
        >
          &#8594; Children
        </h4>
