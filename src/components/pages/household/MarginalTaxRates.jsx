...
export function MarginalTaxRates(props) {
  ...
  const earningsArray =
    household.households["your household"].household_market_income["2022"];
  ...
  const mtrVariable =
    PolicyEngine.metadata.variables[PolicyEngine.variableNames.mtr];
  return (
    <div style={{ padding: 20, paddingLeft: 40 }}>
      ...
      <h1 style={{ marginTop: 50 }}>
        ...
        {PolicyEngine.getFormattedSimulatedValue(
          "marginal_tax_rate",
          "2022",
          "you"
        )}
