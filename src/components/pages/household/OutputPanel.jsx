...
export default function OutputPanel() {
  ...
  const netIncome = PolicyEngine.getSimulatedValue(
    PolicyEngine.variableNames.netIncome
  );
  const netIncomeFormatted = PolicyEngine.getFormattedSimulatedValue(
    PolicyEngine.variableNames.netIncome
  );
      ...
      <>
        {!isExpanded && (
          ...
          >
            {netIncome ? (
              <h3>
                You'll take home {netIncomeFormatted} after taxes and benefits
              </h3>
            ) : (
