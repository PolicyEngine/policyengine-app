...
The table below summarises key metrics for each tax in the UK system, comparing PolicyEngine's 2025 calendar year revenue projections with 2025-26 fiscal year projections from the government (such as the Office for Budget Responsibility). While PolicyEngine models interactions from instituting or repealing tax and benefit programs, this chart shows only the direct revenue collected from each tax, for consistency with government reports. It also shows PolicyEngine's projection for the percentage of the population affected by each tax in 2025. In the following sections, we dive deeper into each of these taxes, examining their structure, implementation, and distributional impact across income groups.
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| Income tax                         | [322.2](https://gist.github.com/vahid-ahmadi/505f1a571d3e71e594a4565b75380c56)                                                   | [328.7](https://obr.uk/forecasts-in-depth/tax-by-tax-spend-by-spend/income-tax/)                                                                                                                                                                                                                                                          | 80.2                                               |
| National Insurance                 | [179.7](https://gist.github.com/vahid-ahmadi/699656a3705a44c817473d06c7f5d8f6)                                                   | [198.8](https://obr.uk/forecasts-in-depth/tax-by-tax-spend-by-spend/national-insurance-contributions-nics/)                                                                                                                                                                                                                               | 67.5                                               |
