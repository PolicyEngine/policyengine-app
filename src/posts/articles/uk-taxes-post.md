...
The VAT calculation sums the tax from standard-rated items (consumption × 20%) and reduced-rated items (consumption × 5%), then divides by a factor to account for under-reporting. This approach ensures that modeled VAT revenue aligns with official government statistics.
