...
- **Carbon Pricing:** In the UK, we can model hypothetical policies like a [carbon tax](https://legacy.policyengine.org/uk/research/how-policyengine-estimates-the-effects-of-uk-carbon-taxes) paired with a dividend. Our UK model demonstrated the distributional effects of pairing a £100/tonne carbon tax with an £18/week universal dividend, showing potential outcomes across income and wealth levels.
...
- **Energy Price Regulations:** We have modeled policies like the [UK's Energy Price Guarantee](https://legacy.policyengine.org/uk/research/projected-impact-of-the-uks-extended-energy-price-guarantee), which capped household energy costs.
