...
The table below summarises key metrics for each benefit in the UK system, showing PolicyEngine's implementation and the specific values for 2025.

| Programme                       | PolicyEngine implementation                                                           | Key rates (2025)                                                                                                                                                                                                                                                      |
| ------------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
