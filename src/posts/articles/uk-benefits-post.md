...
<small>\* This estimation assumes that all eligible families for this programme apply, and as the childcare programmes have interactions with each other, the practical revenue impact is likely lower than PolicyEngine's estimation.</small>
