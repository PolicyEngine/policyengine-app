...
In our [previous report](https://legacy.policyengine.org/us/research/wyden-smith-ctc), we showed how the TRAFWA would affect a single parent of two in 2023. That analysis still holds, so here we’ll show a more complex example: a married family with three children, in 2025, with $10,000 of earnings in 2024. This household would be affected by all TRAWFA CTC reforms: the refundability rise, phase-in rate, inflation adjustment, and lookback provision.
