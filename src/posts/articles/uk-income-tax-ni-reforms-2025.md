...
The Times [reported](https://www.thetimes.com/uk/politics/article/rachel-reeves-budget-watchdog-raise-income-tax-plan-sr2wd8mp7) that an expected Office for Budget Responsibility productivity forecast downgrade would create an estimated £30 billion shortfall in fiscal headroom—the amount needed to meet fiscal rules while maintaining adequate buffers against future economic shocks—that Reeves sought to address with these options. The combined package of income tax increases and National Insurance reductions would raise £6.9 billion in 2026-27, rising to £15.5 billion by 2029-30, while the threshold freeze extension would contribute additional revenue in later years.
