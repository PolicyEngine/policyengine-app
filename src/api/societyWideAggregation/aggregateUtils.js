...
export function aggregateBaselineReformComparison(comparisons, baselineStrategy = 'sum', reformStrategy = 'sum') {
  return {
...
export function aggregateWinnersLosersBreakdownSimple(breakdowns, strategy = "sum") {
  const categories = [
    "Gain less than 5%",
    "Gain more than 5%",
    "Lose less than 5%",
...
export function aggregateWinnersLosersBreakdownDeciles(breakdowns, strategy = "sum") {
  const categories = [
    "Gain less than 5%",
    "Gain more than 5%",
    "Lose less than 5%",
