...
function SidebarItemGroup(props) {
  ...
  const selectedVariableIfExists =
    (PolicyEngine.metadata.variables[PolicyEngine.householdPage] || {})
      .moduleName || PolicyEngine.householdPage;
  const [expanded, setExpanded] = useState(
    props.expanded || selectedVariableIfExists.includes(name)
  );
...
export default function PolicyLeftSidebar(props) {
  ...
  return (
    ...
    >
      <h2 style={{ marginBottom: 50 }}>Policy</h2>
      <Menu
        tree={tree}
