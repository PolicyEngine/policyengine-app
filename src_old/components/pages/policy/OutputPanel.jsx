...
import PolicyOutputHolder from "./outputs/PolicyOutputHolder";

export default function OutputPanel() {
  const PolicyEngine = useContext(PolicyEngineContext);
  const isExpanded = PolicyEngine.policyPage.startsWith("policyOutput.");
  const hasReform = Object.keys(PolicyEngine.policyReform).length > 0;
  console.log(isExpanded, hasReform);
